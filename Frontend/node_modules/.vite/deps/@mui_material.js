...
} from "./chunk-EZSNFYZV.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-DKMVRT4I.js";
import {
  HTMLElementType,
...
var TableFooter = React98.forwardRef(function TableFooter2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTableFooter"
  });
...
var TableSortLabel = React100.forwardRef(function TableSortLabel2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTableSortLabel"
  });
...
var TabScrollButton = React102.forwardRef(function TabScrollButton2(inProps, ref) {
...
var Tabs = React103.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const children = React103.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React103.cloneElement(child, _extends({
...
var ToggleButtonGroupContext = React104.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React105.createContext(void 0);
if (true) {
...
var ToggleButton = React106.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React106.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded79);
  const toggleButtonGroupButtonContextPositionClassName = React106.useContext(ToggleButtonGroupButtonContext_default);
...
var ToggleButtonGroup = React107.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React107.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React107.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
...
function useScrollTrigger(options = {}) {
  ...
  const store = React108.useRef();
  const [trigger, setTrigger] = React108.useState(() => getTrigger(store, other));
  React108.useEffect(() => {
    const handleScroll = () => {
