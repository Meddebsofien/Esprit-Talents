...
} from "./chunk-S47RWIF2.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-JUH7TK4A.js";
import {
  HTMLElementType,
  chainPropTypes,
  detectScrollType,
...
} from "./chunk-C7RHEULH.js";
import {
  Transition_default
} from "./chunk-C26VS3M2.js";
import {
  Table_default,
  getTableUtilityClass,
  tableClasses_default
} from "./chunk-IUZV6SK6.js";
...
var MobileStepper = React57.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime64.jsxs)(React57.Fragment, {
...
function RatingItem(props) {
  ...
  return (0, import_jsx_runtime81.jsxs)(React72.Fragment, {
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime84.jsxs)(React74.Fragment, {
...
var SliderTrack = styled_default("span", {
  ...
  const color = (
    ...
    theme.palette.mode === "light" ? (0, import_colorManipulator9.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator9.darken)(theme.palette[ownerState.color].main, 0.5)
  );
  return _extends({
    display: "block",
    position: "absolute",
...
var SliderThumb = styled_default("span", {
  ...
  [`&:hover, &.${sliderClasses_default.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator9.alpha)(theme.palette[ownerState.color].main, 0.16)}`,
    "@media (hover: none)": {
      boxShadow: "none"
    }
  },
  [`&.${sliderClasses_default.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator9.alpha)(theme.palette[ownerState.color].main, 0.16)}`
  },
  [`&.${sliderClasses_default.disabled}`]: {
    "&:hover": {
      boxShadow: "none"
...
var Step = React85.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime99.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime98.jsxs)(React85.Fragment, {
...
var StepButton = React90.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React90.cloneElement(children, childProps) : (0, import_jsx_runtime106.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React95.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime112.jsxs)(React95.Fragment, {
...
var TableFooter = React97.forwardRef(function TableFooter2(inProps, ref) {
  ...
  return (0, import_jsx_runtime114.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl2,
    children: (0, import_jsx_runtime114.jsx)(TableFooterRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
...
var Tabs = React102.forwardRef(function Tabs2(inProps, ref) {
  ...
  const children = React102.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React102.cloneElement(child, _extends({
...
var ToggleButton = React105.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React105.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded79);
...
var ToggleButtonGroup = React106.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime123.jsx)(ToggleButtonGroupRoot, _extends({
    ...
    children: (0, import_jsx_runtime123.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index) => {
        if (true) {
        ...
        return (0, import_jsx_runtime123.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
          value: getButtonPositionClassName(index),
          children: child
        }, index);
      })
