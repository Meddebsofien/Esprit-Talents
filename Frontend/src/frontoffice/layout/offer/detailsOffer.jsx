...
const DetailsOffer = () => {
    ...
    const imgSrc = data.type === 'Emploi' ? '/src/assets/img/job.jpg' : '/src/assets/img/stage.png';
      ...
      <div className='w-full flex flex-col md:flex-row gap-10'>
        ...
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>
          ...
          <div className='w-full flex flex-wrap md:flex-row gap-2 items-center justify-arround my-10'>
           ...
           { data.type==='Emploi' && <div className='bg-[#cecdff] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center'>
          ...
          <div className='w-full'>
            <button className='button bg-red-400 text-white w-40'>Apply Now</button>
          </div>
        </div>
