    ...
    <header id="header" className="fixed-top bg-white">
      <div className="container d-flex  align-items-center justify-content-between">
        ...
        <nav id="navbar" className="navbar">
          <ul>
            <li>
              <Link className="nav-link scrollto active text-black" to={`/Entreprise`}>
                Home
             </Link>
            </li>
           
            <li>
              <Link className="nav-link scrollto text-black" href="#services" to={`/Entreprise/addOffer`}>
                Ajouter Offer
             </Link>
            </li>
            
            <li>
              <Link className="nav-link scrollto text-black" to={`/Entreprise/offers`}>
                Mes Offer
             </Link>
            </li>
